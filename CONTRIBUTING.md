...
You want to contribute to pony-sform? Awesome.
...
First of all please [search existing issues](https://github.com/krig/pony-sform/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/krig/pony-sform/issues/new).
...
Pony code follows
the [Pony standard library file naming guidelines](https://github.com/ponylang/ponyc/blob/master/STYLE_GUIDE.md#naming).
